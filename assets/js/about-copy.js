...
bens:{
  tag:{ko:'제공하는 것',vi:'Chúng tôi cung cấp',en:'What we provide'},
  h2:{ko:'메이크노브에서 할 수 있는 것',
      vi:'Bạn làm được gì trên MAKENOV',
      en:'What you can do on MAKENOV'},
  items:[
    {t:{ko:'전 세계 제품 둘러보기',vi:'Duyệt sản phẩm toàn cầu',en:'Browse products worldwide'},
     d:{ko:'카테고리와 검색으로 좁히고, 신규 등록순으로 볼 수 있습니다.',
        vi:'Lọc theo ngành hàng và tìm kiếm, xem theo thứ tự mới đăng.',
        en:'Narrow by category and search, or sort by newest listing.'}},
    {t:{ko:'거래 조건 확인',vi:'Xem điều kiện giao dịch',en:'Check trade terms'},
     d:{ko:'수출 단가, 최소주문수량, 납기, 공급 조건을 봅니다.',
        vi:'Xem đơn giá xuất khẩu, số lượng tối thiểu, thời gian giao hàng và điều kiện cung ứng.',
        en:'See export unit price, minimum order quantity, lead time and supply terms.'}},
    {t:{ko:'공급사 정보 확인',vi:'Xem thông tin nhà sản xuất',en:'Check the manufacturer'},
     d:{ko:'설립연도, 보유 인증, 생산능력, 그 회사의 다른 제품을 함께 봅니다.',
        vi:'Năm thành lập, chứng nhận, năng lực sản xuất và các sản phẩm khác của họ.',
        en:'Founding year, certifications, capacity, and their other products.'}},
    {t:{ko:'여러 제품 일괄 문의',vi:'Hỏi nhiều sản phẩm một lần',en:'Enquire about several at once'},
     d:{ko:'관심제품에 담아두고 한 번에 견적을 요청하면 각 공급사에 따로 전달됩니다.',
        vi:'Lưu vào danh sách quan tâm rồi hỏi báo giá một lần, mỗi yêu cầu tới đúng nhà sản xuất.',
        en:'Save them, request quotes in one go, and each request reaches its own maker.'}},
    {t:{ko:'화상 미팅 요청',vi:'Đặt lịch gặp qua video',en:'Request a video meeting'},
     d:{ko:'희망 시간대를 남기면 메이크노브가 공급사와 일정을 잡아 링크를 보내드립니다.',
        vi:'Để lại khung giờ mong muốn, MAKENOV sẽ hẹn lịch với nhà sản xuất và gửi link.',
        en:'Leave your preferred time and we arrange the slot with the maker and send the link.'}},
    {t:{ko:'3개 국어 지원',vi:'Hỗ trợ ba ngôn ngữ',en:'Three languages'},
     d:{ko:'베트남어, 한국어, 영어로 보고 문의할 수 있습니다. 소통이 어려우면 팀이 돕습니다.',
        vi:'Xem và hỏi bằng tiếng Việt, Hàn hoặc Anh. Khó trao đổi thì đội ngũ hỗ trợ.',
        en:'Browse and enquire in Vietnamese, Korean or English, with our team helping when needed.'}},
  ],
},

verify:{
  tag:{ko:'사업자 인증',vi:'Xác thực doanh nghiệp',en:'Business verification'},
  h2:{ko:'인증은 무료이고 1분 정도 걸립니다',
      vi:'Xác thực miễn phí, mất khoảng một phút',
      en:'Verification is free and takes about a minute'},
  desc:{ko:'국가별로 해당 국가의 사업자 등록 정보와 대조합니다.',
        vi:'Đối chiếu với thông tin đăng ký doanh nghiệp của từng quốc gia.',
        en:'Checked against each country’s own business registry.'},
  items:[
    {t:{ko:'베트남',vi:'Việt Nam',en:'Vietnam'},
     d:{ko:'세금코드(MST)를 입력하면 회사명과 주소가 자동으로 채워집니다.',
        vi:'Nhập mã số thuế (MST), tên và địa chỉ công ty tự động điền.',
        en:'Enter the tax code (MST) and company name and address fill in automatically.'}},
    {t:{ko:'한국',vi:'Hàn Quốc',en:'Korea'},
     d:{ko:'사업자등록번호로 국세청 사업자 상태를 조회합니다.',
        ...
        en:'The business registration number is checked with the tax office.'}},
    {t:{ko:'그 외 국가',vi:'Các nước khác',en:'Other countries'},
     d:{ko:'회사 이메일 도메인으로 인증합니다. 무료 이메일은 사용할 수 없습니다.',
        vi:'Xác thực bằng email tên miền công ty. Không dùng được email miễn phí.',
        en:'Verify by company email domain. Free email providers cannot be used.'}},
  ],
},
