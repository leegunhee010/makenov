  ...
  },
  {
    ...
    detail:[
      ...
      {type:'p', text:{
        ...
        ko:'제품 정보: 2.0ml × 4개입 · 제조국 대한민국 · (주)인코아(대구) 미라렛 브랜드. 전용 상세페이지는 추후 보강 예정입니다.',
        en:'Product information: 2.0ml × 4 units · made in Korea · MIRALET brand by INCORE (Daegu). A dedicated detail page will be added later.'}},
    ]
  },
  {
    ...
    detail:[
      ...
      {type:'p', text:{
        ...
        ko:'제품 정보: 50g / 1.69oz · 제조국 대한민국 · (주)인코아(대구) 미라렛 브랜드. 전용 상세페이지는 추후 보강 예정입니다.',
        en:'Product information: 50g / 1.69oz · made in Korea · MIRALET brand by INCORE (Daegu). A dedicated detail page will be added later.'}},
    ]
  },
];
...
const MK_MAKER = {
  stats: [
    { n:'0원',     label:'등록 비용',     note:'상세페이지 제작까지 포함' },
    { n:'인증제',   label:'바이어 자격',   note:'사업자 인증 통과자만 열람' },
