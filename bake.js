...
const SCRIPTS = () => [
  ...
  'assets/js/store-supabase.js', 'assets/js/copy-edit.js', 'assets/js/app.js',
].map(s => s === null
  ...
  const PAGES = [
    ...
    { file: 'maker.html', lang: 'ko',
      ...
      jsonld: [{
        '@context': 'https://schema.org', '@type': 'FAQPage',
        mainEntity: [
          ['제품 등록비가 있나요?', '제품 등록비는 없습니다. 별도의 해외 광고나 추가 제작 서비스를 요청하는 경우에는 범위와 비용을 협의합니다.'],
          ['제품 사진이나 소개자료가 부족합니다', '현재 보유한 사진·카탈로그·소개서를 먼저 보내주세요. 등록에 사용할 수 있는 자료를 확인하고, 추가로 필요한 이미지와 정보를 안내합니다.'],
          ['수출 경험이 없어도 등록할 수 있나요?', '가능합니다. 다만 바이어 상담을 위해 제품 가격·MOQ·규격·납기·공급 가능 범위 등 기본 거래조건은 준비해야 합니다.'],
          ['가격을 공개하고 싶지 않습니다', '가격·MOQ·납기·공급조건은 사업자 인증을 완료한 바이어에게만 공개됩니다. 가격이 주문수량이나 사양에 따라 달라지는 경우 "문의 시 안내"로 표시할 수 있습니다.'],
          ['제품 등록까지 얼마나 걸리나요?', '제품 수, 제출 자료의 상태, 번역과 콘텐츠 구성 범위에 따라 달라집니다. 자료를 확인한 후 예상 게시 일정을 안내합니다.'],
          ['어떤 제품이 바이어 문의를 받기 좋나요?', '제품의 차별점과 거래조건이 명확하고, 이미지·규격·인증 정보가 충분한 제품일수록 바이어가 판단하기 쉽습니다. 다만 제품 등록이나 노출이 문의와 계약을 보장하지는 않습니다.'],
          ['이미 다른 플랫폼에 등록한 제품도 가능한가요?', '가능합니다. MAKENOV 제품 등록은 독점 계약을 전제로 하지 않습니다.'],
