...
(async () => {
  ...
  const PAGES = [
    ...
    { file: 'maker.html', lang: 'ko',
      ...
      desc: '부스비도, 항공권도, 통역도 없이. 사업자 인증을 마친 해외 바이어에게 제품을 상시 노출하고 견적 문의를 받으세요. 등록비 없음, 3개 국어로 등록.',
      canonical: SITE + '/maker.html',
      jsonld: [{
        '@context': 'https://schema.org', '@type': 'FAQPage',
        mainEntity: [
          ['등록 비용이 있나요?', '제품 등록에는 등록비를 받지 않습니다. 광고 집행을 별도로 원하시는 경우에만 협의합니다. 상담 시 정확히 안내드립니다.'],
